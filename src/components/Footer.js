        ...
        <footer id="footer" className="footer-clean pt-5">
            <MDBContainer>
                <div className="row justify-content-center">
                    <div className="col-12 col-md-6 text-center text-md-end"><Link to="/tos.html">Terms of Service</Link></div>
                    <div className="col-12 col-md-6 text-center text-md-start"><Link to="/privacy-policy.html">Privacy Policy</Link></div>
